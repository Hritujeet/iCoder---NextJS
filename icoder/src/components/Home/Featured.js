    ...
    const features = [
        {
            ...
            description:
                "Transform your coding knowledge into compelling stories with our intuitive editor. Create professional, impactful content that resonates with developers worldwide.",
        ...
        },
        {
            ...
            description:
                "Join a thriving ecosystem where passionate developers connect, learn, and grow together. Share your expertise and discover cutting-edge insights from fellow coders.",
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="text-center mb-20">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        Discover the tools and community that will transform
                        your coding journey
                    </p>
                </div>
